...
- **Data (set)**: A set of **objects** on which we observe or measure one or more **characteristics**.

- Objects are individuals, subjects or cases in statistical studies.
...
- The sample is convenient to be collected, but it may NOT **well represent** the population.
