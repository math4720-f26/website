...
```{r}
knitr::include_graphics("./images/03-r/posit-cloud_26.png")
```
...
::: {.column width="30%"}
```{r}
knitr::include_graphics("./images/03-r/landing-1-posit_26.png")
```
:::
...
::: {.column width="70%"}
```{r}
knitr::include_graphics("./images/03-r/posit-free-plan_26.png")
```
:::
:::::
...
<!-- # Install R and RStudio Locally to Your Computer (Optional) {visibility="hidden"} -->

## Install R -- Step 1 {visibility="hidden"}
...
## Install R -- Step 2 {visibility="hidden"}
...
## Install R -- Step 3 {visibility="hidden"}
...
## Welcome to the R World! {visibility="hidden"}
...
## Install RStudio -- Step 1 {visibility="hidden"}
...
## Install RStudio -- Step 2 {visibility="hidden"}
...
## Install RStudio -- Step 3 {visibility="hidden"}
...
## RStudio Screen {visibility="hidden"}
